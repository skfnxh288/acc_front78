...
const insertCustomer = () => {
  ...
  const sendInsert = async () => {
    const data={
      ...
      customerName:parameter.workplaceName,
      customerCeo:parameter.workplaceCeoName,
      businessLicenseNumber:parameter.corporationLicence,
      customerBusinessConditions:parameter.businessConditions,
      customerBusinessItems:parameter.businessItems,
      customerZipCode:parameter.workplaceZipCode,
      customerBasicAddress:parameter.workplaceBasicAddress,
      customerDetailAddress:parameter.workplaceDetailAddress,
      customerTelNumber:parameter.workplaceTelNumber,
      customerFaxNumber:parameter.workplaceFaxNumber,
    }
...
insertCustomer.getLayout = function getLayout(page: ReactElement) {
