...
const NoteReceivableSpecification = () => {
    ...
    const searchFundPlan = () => {
        const sendData:any = { accCode: '0110', noteType: 'receivable'};
...
NoteReceivableSpecification.getLayout = function getLayout(page: ReactElement) {
    return <Layout>{page}</Layout>;
  };

export default NoteReceivableSpecification
